...
class Stock:
    ...
    def stock(self, info):
        ...
        for key in self._stock_info:
            ...
            i += 1
        self.file = open(f"/Users/NEIDER/Desktop/PROYECTO MUSICA/music-store-console/files/stocktaking.txt", "a+")
        text = json.dumps(self._stock_info)
        self.file.write(f"{text}\n")
        self.file.close()

    def show_stock(self, ide):
        self.container = return_exist("/Users/NEIDER/Desktop/PROYECTO MUSICA/music-store-console/files/stocktaking.txt")

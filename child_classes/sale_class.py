...
class Sale(Facture):
    ...
    def sale(self, info):
        ...
        for key in self._sale_info:
            ...
            i += 1
        self.write_into("/Users/NEIDER/tienda m/music-store-console/files/sale.txt", self._sale_info)
    ...
    def show_range_date(self, date_init, date_final):
        ...
        self.container = return_exist("/Users/NEIDER/tienda m/music-store-console/files/sale.txt")

...
class Sale(Facture):
    ...
    def sale(self, info):
        ...
        for key in self._sale_info:
            ...
            i += 1
        self.write_into("C:/Users/ESTUDIANTES/Documents/fundamntos_xd/music-store-console/files/sale.txt", self._sale_info)
    ...
    def show_range_date(self, date_init, date_final):
        ...
        self.container = return_exist("C:/Users/ESTUDIANTES/Documents/fundamntos_xd/music-store-console/files/sale.txt")

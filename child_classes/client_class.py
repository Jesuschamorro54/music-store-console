...
class Client(Entity):
    ...
    def client(self, info):
        ...
        self.write_into("/Users/NEIDER/Desktop/PROYECTO MUSICA/music-store-console/files/client.json", self._client_info)

    def show_client(self, ide, name):
        self.container = return_exist("/Users/NEIDER/Desktop/PROYECTO MUSICA/music-store-console/files/client.json")

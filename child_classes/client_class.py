...
class Client(Entity):
    ...
    def client(self, info):
        ...
        self.write_into("C:/Users/ESTUDIANTE/Documents/music/music-store-console/files/client.json")
    def show_client(self, ide, name):
        self.container = return_exist("C:/Users/ESTUDIANTE/Documents/music/music-store-console/files/client.json")

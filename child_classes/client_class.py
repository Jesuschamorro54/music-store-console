...
class Client(Entity):
    ...
    def client(self, info):
        ...
        self.write_into("C:/Users/ESTUDIANTES/Desktop/Programación Orientada a Objetos/Sexta Clase/music-store-console/files/client.txt", self._client_info)

    def show_client(self, ide, name):
        self.container = return_exist("C:/Users/ESTUDIANTES/Desktop/Programación Orientada a Objetos/Sexta Clase/music-store-console/files/client.txt")

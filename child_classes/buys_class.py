...
class Buy(Facture):
    ...
    def buy(self, info):
        ...
        for key in self._sale_info:
            ...
            i += 1
        self.write_into(get_file_path("buys.txt"), self._sale_info) # funcion para la ruta dinamica. antes "self.write_into("/Users/jesuschamorro/Downloads/dev/POO/Parcial_III/child_classes/files/buys.txt", self._sale_info)"
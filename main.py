...
while True:
    ...
    #  REPORTE DE VENTAS
        ...
        sale_ins.show_range_date(date1, date2)
        input("Presione ENTER para continuar...")
        id_sale = int(input("Ingrese ID de venta para detalle: "))
        sale_ins.show_by_id(id_sale)
        input("Presione ENTER para continuar...")
        id_client = int(input("Ingrese ID de cliente para detalle: "))
        name_client = input("Ingrese nombre de cliente para detalle: ")
        client_ins.show_client(id_client, name_client)
        input("Presione ENTER para continuar...")
        id_inventory = int(input("Ingrese ID de inventario para detalle: "))
        stock_ins.show_stock(id_inventory)
        input("Presione ENTER para continuar...")    
